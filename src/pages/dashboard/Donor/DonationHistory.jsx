        ...
        <>
            ...
            >
                ...
                <div className="mx-4 mb-4 rounded-xl bg-accent/60 border border-emerald-100 px-4 py-3.5">
                    ...
                    <p className="text-xs text-muted leading-snug">Keep donating to grow your impact!</p>
                </div>
    ...
    return (
        <>
            <div className="grid grid-cols-3 gap-5 mb-8">
                <StatCard value={totalDonations} label="Total Donations" delay={0} />
                <StatCard value={deliveredCount} label="Delivered" delay={0.05} />
                <StatCard value={activeCount} label="Active / In Progress" delay={0.1} />
            </div>
